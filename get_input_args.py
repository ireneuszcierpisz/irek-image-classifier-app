...
def get_input_args():
    ...
    parser.add_argument('--saved_model_path' , type=str, default='checkpoint/flower102_checkpoint.pth', help='path of saved model')
    parser.add_argument('--dir', type=str, default='flowers/', help='path to the folder of flowers')
    ...
    parser.add_argument('--image_path', type=str, default='flowers/test/1/image_06743.jpg', help='Path of image to be predicted') 
